...
- [目的](#目的)
- [手順](#手順)
  - [8.1 モデルファイルを作成する](#81-モデルファイルを作成する)
  - [8.2 基本的なモデル構造](#82-基本的なモデル構造)
  - [8.3 リレーションの実装](#83-リレーションの実装)
  - [8.4 スコープの実装](#84-スコープの実装)
  - [8.5 Enum定義の実装](#85-enum定義の実装)
  - [8.6 全文検索の実装](#86-全文検索の実装)
- [出力](#出力)
