...
- [目的](#目的)
- [手順](#手順)
  - [10.1 ルーティングを定義する](#101-ルーティングを定義する)
  - [10.2 コントローラを実装する](#102-コントローラを実装する)
  - [10.3 シリアライザを実装する](#103-シリアライザを実装する)
  - [10.4 ページネーションを実装する](#104-ページネーションを実装する)
  - [10.5 フィルタリングを実装する](#105-フィルタリングを実装する)
  - [10.6 ソートを実装する](#106-ソートを実装する)
  - [10.7 リレーションの展開を実装する](#107-リレーションの展開を実装する)
  - [10.8 エラーハンドリングを実装する](#108-エラーハンドリングを実装する)
- [出力](#出力)
