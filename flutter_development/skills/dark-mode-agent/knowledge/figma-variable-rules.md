...
|------------------|---------|-----|------|
| color/background/dark | AppColors.backgroundDark | Color(0xFF121212) | 画面背景色 |
| color/surface/dark | AppColors.surfaceDark | Color(0xFF1E1E1E) | カード背景色 |
| color/primary | AppColors.primary | Color(0xFFBB86FC) | プライマリ色 |
| color/on-primary | AppColors.onPrimary | Color(0xFF000000) | プライマリ上のテキスト色 |
| color/error | AppColors.error | Color(0xFFCF6679) | エラー色 |
